...
SELECT B.ISBN, B.TITLE, O.ORDER#, C.STATE
FROM BOOKS B
         LEFT OUTER JOIN ORDERITEMS OI ON OI.ISBN = B.ISBN
...
SELECT B.TITLE           "BOOK TITTLE",
       P.NAME            "PUBLISHER'S NAME",
       B.RETAIL - B.COST "PROFIT AMOUNT",
       PM.GIFT           "FREE GIFT DESCRIPTION"
FROM BOOKS B,
     PUBLISHER P,
     PROMOTION PM
WHERE B.PUBID = P.PUBID
  AND B.RETAIL BETWEEN PM.MINRETAIL AND PM.MAXRETAIL;
